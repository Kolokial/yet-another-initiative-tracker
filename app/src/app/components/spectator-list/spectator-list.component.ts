...
import { HasPeerId } from 'src/app/types/InitiativeDetail';
...
export class SpectatorListComponent {
  public spectatorList: TableListDataSource<HasPeerId>;
  public displayedColumns: string[] = ['displayName', 'initiativeValue'];

  constructor(cdr: ChangeDetectorRef) {
    this.spectatorList = new TableListDataSource<HasPeerId>(cdr);
  }
}
